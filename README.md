...
新しい教材の作成・改修では、設計原則とAI-GUIDEを確認し、学習目標・繰り返す学習行動・対象端末・保存の要否を決めてから、必要な資産だけを選びます。
...
3. 子どもが繰り返す学習行動と、1回の学習単位を決める。
4. 必要な共通資産と使わない資産を決める。
5. 正本の実装と公開カタログで、API・クラス・ID・画像パスを確認する。
6. 学習骨格を作り、タブレット横向きの1画面で主要操作を確認する。
7. 必要な場合だけ、ナビキャラ・音・演出・バッジを加える。
8. 正解・不正解・つまずき・再挑戦・結果・ホーム復帰・リロードを確認する。
9. [更新・検証ルール](MAINTENANCE.md)に沿って点検する。
...
最初に DESIGN-PRINCIPLES.md、AI-GUIDE.md、該当する skills/*/SKILL.md を読んでください。
既存教材では、編集前に問題データ・正答・判定・保存・画像リンクを確認し、保護対象を明記してください。
